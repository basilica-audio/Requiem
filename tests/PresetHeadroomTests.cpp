...
// The factory-preset headroom gate (issue #46).
//
...
namespace
{
    ...
    // Seventeen factory presets ship - CMakeLists.txt's juce_add_binary_data
    ...
    constexpr int shippedFactoryPresetCount = 17;
